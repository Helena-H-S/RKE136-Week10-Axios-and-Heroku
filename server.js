...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?api_key=12ec8c33c90bff4ec6d7b5d0ba13abbe&query=${userMovieTitle}`;
    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=12ec8c33c90bff4ec6d7b5d0ba13abbe&query&language=en-US';
...
app.post('/getmovie', (req, res) => {
	...
	const reqUrl = encodeURI(
		`http://www.omdbapi.com/?t=${movieToSearch}&apikey=621d6f46`
	);
	http.get(
		reqUrl,
		responseFromAPI => {
